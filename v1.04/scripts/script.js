...
function fetchDailyBirdData() {
   ...
   .then(response => {
        ...
        // function populateTemplate(titleName, titleSci, locale, obDate) {
        //     const templateChart = 
        //     document.getElementById("temp-daily").content.cloneNode(true);
        
        //     templateChart.querySelector('.card-title').innerText = titleName;
        //     templateChart.querySelector('.card-title-sci').innerText = titleSci;
        //     templateChart.querySelector('.card-location').innerText = locale;
        //     templateChart.querySelector('.card-date').innerText = obDate;
        ...
        //     populateTemplate(item.comName, item.sciName, 
        //     item.locName, item.obsDt)
        // })
